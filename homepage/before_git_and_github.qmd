...
This module uses git from the command line and VScode, with a focus on collaborating with others. (If you took module 1, this goes further than the git-in-RStudio session.)
