...
author: "Abu Bakar Siddique, Bioinformatician, SLUBI"
date: "2025-10-10"
format: 
    revealjs:
        slide-number: c/t
        logo: figures/ggplot/logo.png
        width: 1600
        height: 900
        theme: simple
...
pacman::p_load(dplyr, tidyr, ggplot2, kableExtra, patchwork, palmerpenguins, plotly, ggiraph)
...
::: columns
::: {.column width="40%"}
![](figures/ggplot/anscombe.jpg)
:::

::: {.column width="50%"}
![](figures/ggplot/datasaurus.jpg)
:::
:::   
...
::: columns
::: {.column width="25%"}
![](figures/ggplot/gogv1.png)\
![](figures/ggplot/gog.jpg)
:::
...
::: {.column width="75%"}
![](figures/ggplot/syntax.png){width="100%"}
:::
:::
...
::: columns
::: {.column width="40%"}
![](figures/ggplot/tidy.png){width="100%"}
:::
...
![](figures/ggplot/complicated-graphs.jpg)
...
![](figures/ggplot/scales.png){width="50%"}
:::
...
![](figures/ggplot/bbc.png){width="95%"}
...
##  {background-image="../../figures/ggplot/images/cover.jpg"}

### Thank you! Questions?
::: columns
::: {.column width="70%"}
![](figures/ggplot/ggplot2_masterpiece_v1.png)
:::
:::
